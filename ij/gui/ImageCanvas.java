...
public class ImageCanvas extends JPanel implements MouseListener, MouseMotionListener, Cloneable {
    ...
    */
	...
	public Rectangle getSrcRect() {
        ...
        public void setSrcRectPos(int x, int y){
          int xpos=x;
          int ypos=y;
          if(xpos<0) xpos=0;
          if(ypos<0) ypos=0;
          //if((xpos+srcRect.width)>imageWidth&&xpos!=0) xpos=imageWidth-srcRect.width;
          //if((ypos+srcRect.height)>imageHeight&&ypos!=0) ypos=imageHeight-srcRect.height;
          srcRect.x=xpos;
          srcRect.y=ypos;
          imp.draw();
          Thread.yield();
